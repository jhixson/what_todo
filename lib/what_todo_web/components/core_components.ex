defmodule WhatTodoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WhatTodoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WhatTodoWeb.Gettext, "errors", msg, opts)
    end
  end
